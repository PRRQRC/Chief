...
export const FACTION_NAME = process.env.FACTION_NAME ?? 'r/placeQRcode';
export const FACTION_CONTACT = process.env.FACTION_CONTACT ?? 'https://discord.gg/kkVGgtY8XX';
...
export const POSTGRES_CONNECTION_URI = process.env.POSTGRES_CONNECTION_URI ?? 'postgres://postgres:chief@chiefdb:5432/chief';
export const STATS_INTERVAL = parseInt(process.env.STATS_INTERVAL ?? 2500)
export const KEY = process.env.KEY || "/etc/letsencrypt/live/rick.fairuse.org/privkey.pem";
export const CERT = process.env.CERT || "/etc/letsencrypt/live/rick.fairuse.org/fullchain.pem";
